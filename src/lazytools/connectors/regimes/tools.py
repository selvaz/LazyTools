...
class RegimeTools:
    ...
    def as_tools(self) -> list[Any]:
        ...
        read = [
            ...
            (r.get_regime_changes, "regime_get_changes"),
        ...
        write = [
            ...
            (r.load_time_series, "regime_load_time_series"),
        ...
        tools = [Tool.wrap(fn, name=name) for fn, name in read]
        if self._allow_write:
            tools += [Tool.wrap(fn, name=name) for fn, name in write]
        return tools
