    ...
    def as_tools(self) -> list[Any]:
        ...
        descriptions = {
            ...
            "regime_load_from_datahub": (
                ...
                "symbols — a single symbol is just 'SPY'. For MULTIPLE "
                "symbols: in-process a list works (['SPY','TLT']), but over "
                "the MCP wire this argument is a string, so pass them as ONE "
                "comma-separated string 'SPY,TLT,GLD' (the loader splits it on "
                "commas). All symbols must "
