...
BUNDLES: dict[str, tuple[str, ...]] = {
    ...
    "fund": ("symbol", "description", "aum", "expense_ratio", "nav_premium", "holdings_count",
             "weight_top_10", "index_provider", "flow_1m", "flow_3m", "flow_ytd",
             "perf_ytd", "avg_volume_90d"),
    "fundamentals": ("symbol", "description", "currency", "fundamental_currency", "market_cap",
                     "pe_ttm", "pb", "ev_ebitda", "roe", "debt_to_equity", "gross_margin",
                     "net_margin", "revenue_growth_yoy", "dividend_yield", "beta_1y"),
    ...
    "consensus": ("symbol", "currency", "fundamental_currency", "close", "target_avg",
